...
public class NursingStudentContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StudentClass>()
            ...
            .HasForeignKey(sc => new { sc.class_ID, sc.category_ID });

        modelBuilder.Entity<Class>()
            .HasKey(c => new { c.class_ID, c.category_ID });
        ...
        modelBuilder.Entity<ClassCategory>().HasData(
            new ClassCategory { category_ID = 1, categoryName = "Accounting", categoryPrefix = "ACCT" },
            new ClassCategory { category_ID = 2, categoryName = "Agriculture", categoryPrefix = "AGRI" },
            new ClassCategory { category_ID = 3, categoryName = "Agriculture", categoryPrefix = "AGRM" },
            new ClassCategory { category_ID = 4, categoryName = "Anthropology", categoryPrefix = "ANTH" },
